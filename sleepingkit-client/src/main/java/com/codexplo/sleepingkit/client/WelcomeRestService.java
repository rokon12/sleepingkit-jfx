...
import com.codexplo.sleepingkit.common.WelcomeMessage;
...
public class WelcomeRestService {
     ...
     * <p/>
     * By default the URL will point to 'http://localhost:8080/sleepingkit-server' which should hit your
     ...
     *                  'http://localhost:8080/sleepingkit-server'
     */
